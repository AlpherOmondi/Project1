...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\project1\cd0046-SQL-and-Data-Modeling-for-the-Web\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\project1\cd0046-SQL-and-Data-Modeling-for-the-Web\env\Scripts\deactivate.nu'
